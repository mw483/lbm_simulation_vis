...
void Set_Value::output_info () {
	...
	std::cout << "-                                       -" << std::endl;
	std::cout << "- Ver.1.0 (2021/03/8)                   -" << std::endl;
	...
	std::cout << "-                                       -" << std::endl;
	std::cout << "- Ver.1.1 (2021/03/15)                  -" << std::endl;
...
void Set_Value::output_setting (Setting& setting) {
	...
	std::string	flg_num				= "on";
	std::string	flg_density		= "on";
	std::string	flg_profile		= "on";
	std::string	flg_footprint	= "on";
	std::string	flg_flux			= "on";
	std::string	flg_residual	= "on";

	if (setting.FLG_NUM 		== 0) flg_num 			= "off";
	if (setting.FLG_DENSITY == 0) flg_density 	= "off";
	if (setting.FLG_PROFILE == 0) flg_profile 	= "off";
	if (setting.FLG_FOOT		== 0) flg_footprint = "off";
	if (setting.FLG_FLUX 		== 0) flg_flux			= "off";
	if (setting.FLG_RESID 	== 0) flg_residual 	= "off";
